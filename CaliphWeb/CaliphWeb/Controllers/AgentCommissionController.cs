...
namespace CaliphWeb.Controllers
{
    public class AgentCommissionController : Controller
    {
        ...
        public async Task<ActionResult> Summary()
        {
            ...
            var gainPercent3 = decimal.Parse(lastYearmar3Amt) == 0 ? (((decimal.Parse(currentYearmar3Amt) - decimal.Parse(lastYearmar3Amt))) * 100).ToString("n2") : (((decimal.Parse(currentYearmar3Amt) - decimal.Parse(lastYearmar3Amt)) / decimal.Parse(lastYearmar3Amt)) * 100).ToString("n2");
