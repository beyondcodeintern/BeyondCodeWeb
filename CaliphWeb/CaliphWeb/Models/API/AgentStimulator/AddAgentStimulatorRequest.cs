...
namespace BeyondCode.Models.API.AgentStimulator
{
    public class AddAgentStimulatorRequest
    {
        ...
        public int AgentSimulatorTypeId { get; set; }
    ...
    public class UpdateAgentStimulatorRequest
    {
        public int AgentSimulatorId { get; set; }
        public decimal GrowthPercentage { get; set; }
        public int Manpower_YTDRecruit1 { get; set; }
    ...
    public class AgentStimulatorFilterRequest
    {
        public object AgentSimulatorId { get; set; }
        public object AgentSimulatorTypeId { get; set; }
        public object AgentSimulatorYear { get; set; }
        public object AgentSimulatorMonth { get; set; }
        public object UserId { get; set; }
        public object StatusId { get; set; }
        public int PageSize { get; set; }
        public int PageNumber { get; set; }
    }
    public class AgentStimulatorFilterResponse
    {
        public int AgentSimulatorId { get; set; }
        public int UserId { get; set; }
        public int AgentSimulatorTypeId { get; set; }
        public string AgentSimulatorTypeDesc { get; set; }
