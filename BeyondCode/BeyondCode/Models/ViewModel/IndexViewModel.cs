...
namespace BeyondCode.Models.ViewModel
{
    ...
    public class BonusTrackerDashboard {
        ...
        public double ACE_CompleteProgress => PotentialBonus.ACE == 0 ? 0 : (ACE / (double)PotentialBonus.ACE) * 100;
        public double Cases_CompleteProgress => PotentialBonus.Cases == 0 ? 0 : (Cases / (double)PotentialBonus.Cases) * 100;
        public double PersistencyRatio_CompleteProgress => PotentialBonus.PR_D0 == 0 ? 0 : (PersistencyRatio / (double)PotentialBonus.PR_D0) * 100;
    ...
    public class BonusTrackerViewModel {
        ...
        public double PersistencyRatio => ACE == 0 ? 0 : PersistencyPremium / ACE;
