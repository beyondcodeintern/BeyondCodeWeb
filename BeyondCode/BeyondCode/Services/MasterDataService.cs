...
namespace BeyondCode.Services
{
    public class MasterDataService : IMasterDataService
    {
        ...
        public async Task<List<MasterData>> GetResourceStatusAsync()
        {
            var response = await _caliphAPIHelper.PostAsync<ResponseData<List<MasterData>>>("/api/v1/master/get-resource-status");
            return response.Data;
        }
